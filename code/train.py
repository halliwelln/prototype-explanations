...
parser.add_argument('shuffle_labels',type=str)
...
if SHUFFLE_LABELS=='yes':
    print('Shuffling labels')
    y_train_one_hot = tf.random.shuffle(y_train_one_hot,seed=SEED)
...
if SHUFFLE_LABELS=='yes':
    model.save_weights(f'{WEIGHT_PATH}{DATA}_shuffled.h5')
else:
